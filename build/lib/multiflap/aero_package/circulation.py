'''
file circulation.py
@author Victor Colognesi, Gennaro Vitucci, Gianmarco Ducci
...
def circulation_polar(y,z,yc,zc,chord,angle_of_attack,cl_alpha,velocity_module,gamma):
...
def inucedvel_filament(X1,Xleg,legdir, vstrength):
