...
class Joint:
    ...
    def __init__(self, offset=0, amplitude=1, phase=0):
        self.offset = offset
...
class BirdLiftingline:
    ...
    def compute_liftingline(self, t):
        ...
        shoulder_y = self.shoulder.axis_y.motion_joint(t)
        shoulder_z = self.shoulder.axis_z.motion_joint(t)
        # Elbow motion
        elbow_x = self.elbow.axis_x.motion_joint(t)
        elbow_y = self.elbow.axis_y.motion_joint(t)
        # Wrist motion
        wrist_y = self.wrist.axis_y.motion_joint(t)
        wrist_z = self.wrist.axis_z.motion_joint(t)
        """
